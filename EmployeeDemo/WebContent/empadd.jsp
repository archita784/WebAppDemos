...
From state : <%=employee.getAddress().getState()%><br>
From city : <%=employee.getAddress().getCity()%><br>
Contact at: <%=employee.getMobileNo() %><br>
<br>
<h4>Expression Language</h4>
Welcome : ${employee.empname}<br>
Employee Id :${employee.empid}<br>
From state : ${employee.address.state}><br>
From city : ${employee.address.city}<br>
